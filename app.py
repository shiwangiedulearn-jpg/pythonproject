...
set_bg_from_local("background.jpg")  # Make sure this image is in the same folder
...
st.markdown("""
   ...
   /* Sidebar container */
    ...
    /* Normal buttons */
    .stButton>button {
        background-color: #00ffe0 ;  /* Bright cyan */
    ...
    .stButton>button:hover {
        background-color: #00ccaa !important;  /* Slightly darker on hover */
